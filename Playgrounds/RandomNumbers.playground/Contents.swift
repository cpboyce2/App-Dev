...
func initializeArray(size : Int) -> Array<Int> {
...
class Question {
    ...
    init(text: String, correctAnswer: Bool){
        let questionText: String = text
        let answer: Bool = correctAnswer
    }
...
class QuestionBank {
    ...
    var list = [Question]()
    // The above line is just being used to specify the type of data that is going to be in the array
